...
3. **You must also update `start.command`** so it switches to that version before starting
...
| Environment | Node version · what was installed vs. reused · `start.command` verified |
