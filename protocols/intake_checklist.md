...
| E3 | Primary explanation language / strongest language | The language AI should use for difficult explanations, corrections, and feedback — even when the subject itself is English | profile (durable personal preference) |
| E4 | Learning-content language | English / another language / bilingual; this may differ from E3 | profile |
| E5 | Other constraints | Device, accessibility, deadlines | profile |
