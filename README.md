...
| :--- | :--- | :--- |
| **`Chinese`** | Chinese-primary docs (may mix English terms) | Windows baseline / Chinese-primary users |
| **`English`** | Fully English documentation | English-primary users |
| **`macos-chinese`** (this branch) | Chinese template + complete macOS reader | Chinese-primary macOS users |
