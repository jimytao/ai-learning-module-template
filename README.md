...
To launch the reader, double-click **`start.command`** (the first run installs dependencies
and opens the browser), or run `npm start` and open <http://127.0.0.1:4173> yourself.

> This branch targets **macOS**. If you are on Windows, use the matching branch that
> ships `start.bat`.
