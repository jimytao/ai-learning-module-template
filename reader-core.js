(function initReaderCore(globalScope, factory) {
  ...
  function tokenHtml(token) {
    ...
    return `<div class="answer-block"><label>Answer</label><textarea class="interactive-textarea" data-type="textarea" data-index="${token.index}" rows="4">${escapeHtml(token.value)}</textarea></div>`;
  }
